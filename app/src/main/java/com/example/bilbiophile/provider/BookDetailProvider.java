...
public class BookDetailProvider implements
    ...
    private void startDownload(Book book) {
        DownloadTask task = new DownloadTask(mContext, IdProvider.generateTaskId(), book.guid + ".json");
    ...
    private void startParsing() {
        ...
        JsonParseTask task = new JsonParseTask(mContext, IdProvider.generateTaskId(), mBookStart);
        task.addListener(this);
